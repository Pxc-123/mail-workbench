...
(function (global) {
  ...
  const SCENE_LABELS = { "1": "初次开发陌生客户", "2": "跟进意向客户推送最新行业新闻", "3": "通知展位余量紧张催单", "4": "通知创新大奖申报截止提醒", "5": "展会补贴政策通知", "6": "发送参展报价方案", "7": "客户跟进回访", "8": "参展感谢与维系" };
  ...
  function buildEmail(exhibition, customer_type, scene, tone, custom_input, signature) {
    ...
    const subject_map = {
      ...
      "4": `【申报截止提醒】${ex} 创新大奖即将关闭通道`,
      "5": `【补贴政策】${ex} 参展补贴可显著降低出海成本`,
      "6": `【参展报价方案】${ex} 展位费用与投入回报`,
      "7": `【跟进】${ex} 参展意向确认，请查收`,
      "8": `【感谢】感谢关注 ${ex}，后续资源持续开放`,
    };
  ...
  function seedDemo(d) {
    ...
    [["跟进XX预制菜厂参展意向", fmt(1), "高"], ["发送SIAL展位图给YY调味品", fmt(2), "中"],
     ["准备创新大奖申报材料", fmt(4), "高"], ["整理越南食品展客户名单", fmt(0), "低"]].forEach(t =>
